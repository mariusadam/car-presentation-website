...
<div id="content2">
<h2>Autentificare Administrator</h2> <br>
<div id="main">
 <form action="login.php" method="POST">
 <table align="center" cellpadding="3">
  <tr>
   <td>Username</td>
   <td><input type="text" name="us" size="25"></td>
  </tr> 
  <tr>
   <td>Parola</td>
   <td><input type="password" name="pas" size="25"></td>
  </tr> 
  <tr>
   <td></td>
   <td align="center"> <input type="submit" name="buton" value="Autentificare" /></td>
  </tr>
 </table>
 </form>
</div>
