...
<title>BMW 430d xDrive Coupe</title>
...
<div id="content3">
<h2>BMW 430d xDrive Coupe</h2> <br />
<div id="main">
 <P><img src="images/r13_pret.jpg"></P>
 <P><img src="images/r13_eq.jpg"></P>
 </div>
<br>
<div class="clear"></div>
</div><br>
	...
	<div class="ws_images"><ul>
		<li><img src="data0/images/r13_3.jpg" alt="r13_3" title="r13_3" id="wows0_0"/></li>
		<li><a href="http://wowslider.com/vf"><img src="data0/images/r13_1.jpg" alt="full screen slider" title="full screen slider" id="wows0_1"/></a></li>
		<li><img src="data0/images/r13_2.jpg" alt="r13_2" title="r13_2" id="wows0_2"/></li>
	</ul></div>
	<div class="ws_bullets"><div>
		<a href="#wows0_0" title="r13_3"><img src="data0/tooltips/r13_3.jpg" alt="r13_3"/>1</a>
		<a href="#wows0_1" title="full screen slider"><img src="data0/tooltips/r13_1.jpg" alt="full screen slider"/>2</a>
		<a href="#wows0_2" title="r13_2"><img src="data0/tooltips/r13_2.jpg" alt="r13_2"/>3</a>
	</div></div>
	<div class="ws_shadow"></div>
	</div>	
	<script type="text/javascript" src="engine0/wowslider.js"></script>
	<script type="text/javascript" src="engine0/script.js"></script>
	<!-- End WOWSlider.com BODY section --><div class="clear">
	</div>
